    ...
    if (selectedFile) {
        ...
        fileReader.onload = function(e){
            ...
            woorbook.SheetNames.forEach(async sheet=>{
                ...
                for await(let {Fecha,Tipo,"Punto de Venta":puntoVenta,"Número Desde":numeroDesde,"Tipo Doc. Receptor":tipo_dni,"Nro. Doc. Receptor":dni,"Imp. Total":total} of datos){
                    ...
                    const cliente = "Consumidor Final".padEnd(30," ");
