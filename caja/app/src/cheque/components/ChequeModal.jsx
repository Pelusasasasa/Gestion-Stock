...
import { verificarDatosCheque } from '../../helpers/verificarDatos';
...
export const ChequeModal = ({ cerrar }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        if (await !verificarDatosCheque(formState)) return;
    ...
    return (
        <div className='fixed inset-0 flex items-center justify-center bg-black/80 z-50 overflow-auto h-screen'>
            <div className=' p-8 rounded-lg shadow-lg w-full max-w-2xl bg-white'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='flex justify-end gap-4 mt-2'>
                        <button type='button' onClick={salir} className='text-black border-gray-500 border rounded-lg cursor-pointer px-4 py-2  hover:bg-gray-200 focus:outline-none'>Cancelar</button>
