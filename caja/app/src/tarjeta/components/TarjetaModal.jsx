            ...
            <div className=' p-8 rounded-lg shadow-lg w-full max-w-md bg-white'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='flex justify-end gap-4'>
                        ...
                        {!tarjetaActive._id && <button type='submit' className='cursor-pointer px-4 py-2 bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2'>Agregar</button>}
                        {tarjetaActive._id && <button type='button' onClick={handlePutTarjeta} className='cursor-pointer px-4 py-2 bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2'>Modificar</button>}
                    </div>
                </form>
            </div>
        </div>
