...
router.route("/traerPrecio/:id").get(traerPrecio);
router.route("/traerCostoImpuesto/:id").get(traerCostoImpuesto);
router.route("/traerImpuesto/:id").get(traerImpuesto);
router.route("/productosPorMarcas/:lista").get(productosPorMarcas);
